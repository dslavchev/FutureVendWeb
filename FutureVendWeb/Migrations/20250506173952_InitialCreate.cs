        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    PLU = table.Column<string>(type: "longtext", nullable: false),
                    Name = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    PaymentDeviceSerial = table.Column<string>(type: "longtext", nullable: false),
                    VendingDeviceSerial = table.Column<string>(type: "longtext", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerVendingProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerVendingProducts_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerVendingProducts_VendingProducts_VendingProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerVendingProducts_CustomerId",
                table: "CustomerVendingProducts",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerVendingProducts_VendingProductId",
                table: "CustomerVendingProducts",
